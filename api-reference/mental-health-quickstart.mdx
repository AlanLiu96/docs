...
<CodeGroup>
  ```bash cURL
  curl -u username:password --request GET https://healthharbor.co/api/v0/mental_health/inquiries
  ```
...
<CodeGroup>
```bash cURL
curl -u username:password --request POST "https://healthharbor.co/api/v0/mental_health/inquiries" \
...
<CodeGroup>
```bash cURL
curl -u username:password --request GET "https://healthharbor.co/api/v0/mental_health/inquiries/722b06d8-1855-402b-9916-bfa450cc1572"
```
