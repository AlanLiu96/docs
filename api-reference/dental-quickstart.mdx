...
Here is an example of a more complex benefits request that also retrieves frequencies and treatment history. Note the addition of `CODE_LOOKUP_FREQUENCIES` and `TREATMENT_HISTORY` 
to `benefits_query`.
