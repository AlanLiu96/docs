...
url = 'https://healthharbor.co/api/v0/webhooks'
payload = {
  "callback_url": "https://your-webhook-endpoint.com",
  "update_frequency_min": 5
}
...
const url = 'https://healthharbor.co/api/v0/webhooks';
const payload = {
  callback_url: 'https://your-webhook-endpoint.com',
  update_frequency_min: 5
};
